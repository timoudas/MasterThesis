...
function s = bvar
s = BEARsettings(2, 'ExcelFile', 'datab.xls');
...
s.results_sub='bvar_no_prior';
s.results_path = fullfile(pwd, 'results_no_prior');
...
s.FEVDband=0.95; % confidence/credibility level for forecast error variance decomposition
